...
function preload(){
  ...
  masterPuppets = {
    'chicken': loadJSON('newPuppetJSONS/chicken.json'),
    'unicorn': loadJSON('newPuppetJSONS/unicorn.json'),
    'hedgehog': loadJSON('newPuppetJSONS/hedgehog.json'),
    'sillyman_orange': loadJSON('newPuppetJSONS/sillyman_orange.json'),
    'emma': loadJSON('newPuppetJSONS/emma.json'),
    'eric': loadJSON('newPuppetJSONS/eric.json'),
    'matthew': loadJSON('newPuppetJSONS/matthew.json'),
  }
...
function mousePressed(){
  ...
  if(event.button == 2 && !deletingPuppet && puppetAssigning == null){
    ...
    if(puppeteerOnePuppet != null)puppeteerOnePuppet = null;
  }
...
function renderUI(){
  ...
  if(!performanceMode){
    ...
    if(puppeteerOnePuppet != null)helpText = 'Right click to release a puppet.'
...
function displayControls(){
  ...
  var twoHoldingUpDownModify = keyIsDown(16)
...
function fitCanvasToBackground(){
  var maxWidth = constrain(windowWidth - edgeRoom, 500, 1500)
