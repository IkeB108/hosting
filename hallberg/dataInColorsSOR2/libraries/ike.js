...
Number.prototype.between = function(min, max, exclusive){
  //If the exclusive argument is a string that says "exclusive" or "e", or the true boolean,
  //then exclude the minimum or maximum
  if(exclusive == "e" || exclusive == "exclusive")exclusive = true;
  if(exclusive){
